...
class About_us_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'foo_widget', // Base ID
			esc_html__( 'About us info', 'text_domain' ), // Name
			array( 'description' => esc_html__( 'About us info', 'text_domain' ), ) // Args
		);
	}
    ...
    public function widget( $args, $instance ) {
        ...
        $paragraph .= $text;
		$paragraph .= '</p>';
		$button_learn_more = '<div class="btn-link-block"><a class="btn-link" href="#">Learn more</a></div>';

		echo $paragraph;
		echo $button_learn_more;
